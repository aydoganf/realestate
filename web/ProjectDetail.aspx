<%@ Page Title="" Language="C#" MasterPageFile="~/ProjectMaster.master" AutoEventWireup="true" CodeFile="ProjectDetail.aspx.cs" Inherits="ProjectDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphNavigation" runat="Server">
    <a href="/projeler">Projeler</a> &gt; <%=CurrentProject.ProjectName %>
</asp:Content>
                ...
                <div class="span9">
                    ...
                    <div class="row">
                        ...
                        <ul class="nav nav-tabs">
                            <li class="<%= CurrentAdvert == null ? "active" : "" %>">
                                <a href="<%= CurrentAdvert == null ? "javascript:;" : "/proje/" + CurrentProject.ObjectId %>">Proje Anasayfa</a>
                            </li>
                            <asp:Repeater ID="rptProjectAdverts" runat="server" OnItemDataBound="rptProjectAdverts_ItemDataBound">
                                <ItemTemplate>
                                    <li id="liProjectAdvertHousingTypeName" runat="server">
                                        <a href="/proje/<%#Eval("ProjectObjectId") %>/<%#Eval("AdvertObjectId") %>">
                                            <%#Eval("HousingTypeName") %>
                                        </a>
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        ...
                        <div class="span6 gallery">
                            <div class="preview">
                                <img src="/uploads/<%=CurrentProject.PrimaryProjectPhoto %>" alt="">
                            </div>
                                    ...
                                    <div class="span3">
                                        ...
                                        <table>
                                            <tbody>
                                                <tr>
                                                    <th>Teslim Tarihi:</th>
                                                    <td><strong><%=CurrentProject.DeliveryDate %></strong></td>
                                                </tr>

                                                <tr>
                                                    <th>Projedeki Konut Sayısı:</th>
                                                    <td><%=CurrentProject.ProjectHousingCount %></td>
                                                </tr>

                                                <tr>
                                                    <th>Toplam Proje Alanı:</th>
                                                    <td><%=CurrentProject.ProjectTotalArea %> m<sup>2</sup></td>
                                                </tr>

                                                <tr>
                                                    <th>Metrekare Aralığı:</th>
                                                    <td><%=CurrentProject.AreaRange %> m<sup>2</sup></td>
                                                </tr>

                                                <tr>
                                                    <th>Oda Seçenekleri:</th>
                                                    <td><%=CurrentProject.RoomOptions %></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
