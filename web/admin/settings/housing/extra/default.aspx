<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="settings_housing_extra_default" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" Runat="Server">
    <asp:Repeater ID="rptExtra" runat="server" OnItemCommand="rptExtra_ItemCommand">
        <HeaderTemplate>
            <table class="table table-striped table-bordered table-advance table-hover dataTable" id="extraTable">
                <thead>
                    <tr>
                        <td>İşlem</td>
                        <td>Özellik Tipi</td>                     
        ...
        <ItemTemplate>
                    <tr>
                        <td>
                            <a href='data.aspx?feature=<%#Eval("ObjectId") %>'>
