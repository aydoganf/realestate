<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="admin_settings_housing_status_default" %>
        ...
        <ul class="dropdown-menu pull-right" role="menu">
            <li>
                <a href="data.aspx">
                    ...
                    <span>Yeni Yapının Durumu Bilgisi Ekle</span>
                </a>
            </li>
        </ul>
    </li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphMain" Runat="Server">
    <asp:Repeater ID="rptStatus" runat="server" OnItemCommand="rptStatus_ItemCommand">
        <HeaderTemplate>
            <table class="table table-striped table-bordered table-advance table-hover dataTable" id="statusTable">
                <thead>
                    <tr>
                        <td>İşlem</td>
                        <td>Adı</td>
        ...
        <ItemTemplate>
                    <tr>
                        <td>
                            <a href='data.aspx?status=<%#Eval("ObjectId") %>'>
